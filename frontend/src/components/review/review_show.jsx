      ...
      <div className='review-show-wrap'>
        <div className='review-show-container'>
          <div className='review-author-info'>
            <div className='review-author-image-container'
                  onClick={() => this.props.history.push(`/users/${this.state.author._id}`)}>
            ...
            <div className='review-author-container'>
              <div className='review-author-names-wrap'>
                ...
                <div className='review-author-names-container'
                      onClick={() => this.props.history.push(`/users/${this.state.author._id}`)}>
                  <div className='review-show-author-firstname'>{this.state.author.firstName}</div>
                  <div className='review-show-author-lastname'>{this.state.author.lastName}</div>
                </div>
              </div>
          ...
          <div className='review-show-info-conatiner'>
            <div className='review-show-star-info'>
              <div className='review-show-star'>{this.getRatingStars(this.props.review.rating)}</div>
              <div>{formattedDate.toLocaleDateString()}</div>
            </div>
            <div className='review-show-body-info'>{this.props.review.body}</div>
          </div>
          <div>{editButton}</div>
          <div className='review-show-reviewedUser-container'
              onClick={() => this.props.history.push(`/users/${this.state.reviewedUser._id}`)}>
            <i className="fas fa-arrow-left"></i>
            <div className='review-show-reviewedUser'>Click to see {this.state.reviewedUser.firstName}'s other reviews</div>
          </div>
        </div>
      </div>
    </div> 
